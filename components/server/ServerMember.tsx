...
const RoleIconMap = {
  ...
  [MemberRole.ADMIN]: <Shield className="w-4 h-4 ml-2 text-rose-500" />,
};
...
export const ServerMember = ({ member, server }: ServerMemberProps) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          'font-semibold font-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition',
